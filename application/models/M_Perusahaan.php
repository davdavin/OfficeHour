...
class M_Perusahaan extends CI_Model
{
    ...
    {
        return $this->db->query("SELECT perusahaan.id_perusahaan, id_karyawan, nama_karyawan, email_karyawan, posisi_karyawan, status_karyawan, foto_karyawan FROM karyawan 
