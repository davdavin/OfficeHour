...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" style="margin: 10px;">
                            <div class="box box-solid">
                                <form action="<?php echo base_url('ProjectManage/proses_tambah_task_baru') ?>" method="post" id="SimpanData">
                                    <div class="box-body">
    ...
    <script>
        ...
        function Barisbaru() {
            ...
            Baris += '<td>';
            Baris += '<input type="hidden" name="id_project" value="<?= $id_project ?>">' + '<input type="text" name="tugas[]" class="form-control first_name" placeholder="Tugas ...." required="">';
            Baris += '</td>';
            Baris += '<td>';
