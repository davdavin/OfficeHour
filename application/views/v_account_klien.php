                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-primary">
                        <div class="card-body box-profile">
                            ...
                            <?php foreach ($profil as $detail) { ?>
                                <h1 class="profile-username text-center">Profile</h1>

                                <form class="form-update" action="<?php echo base_url() . 'Account_Klien/update_profile' ?>" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" class="form-control bg-input" name="email_klien" value=" <?= $detail->email_client ?>">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo base_url() . 'Account_Klien/update_password' ?>" method="post" class="form-submit">
                            <div class="form-group">
