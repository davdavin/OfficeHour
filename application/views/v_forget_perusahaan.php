            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form action="<?php echo base_url() . 'forget_perusahaan/ganti_pass_perusahaan' ?>" method="post" class="register-form" id="login-form">
                            <div class="form-group">
                                <input type="hidden" value=<?php echo $perusahaan['email_perusahaan']; ?> name="email">
                            </div>
                            <div class="form-group">
