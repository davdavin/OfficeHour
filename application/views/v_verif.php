            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form action="<?php echo base_url() . 'Verifikasi/proses_verifikasi' ?>" method="post" class="register-form" id="login-form">
                            <input type="hidden" name="id_karyawan" value="<?= $karyawan['id_karyawan'] ?>" readonly>
