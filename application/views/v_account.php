          ...
          <div class="card">
            <div class="card-body">
              <div class="card-body box-profile">
                ...
                <h4 class="text-muted text-center">Employeeee</h4>

                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>ID</label>
                      <input type="text" class="form-control" name="id_pegawai" value="" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label>Email</label>
                      <input type="text" class="form-control" name="email_pegawai" value="" required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Alamat Lengkap</label>
                      <input type="text" class="form-control" name="alamat_pegawai" value="" required>
                    </div>
                    <div class="form-group">
                      <label>Status</label>
                      <input type="text" class="form-control" name="status_pegawai" value="" readonly>
                    </div>
                    <div class="form-group">
                      <label>Foto</label>
